...
namespace FDS.Common
{
    public class CertificateDetails
    {
        ...
        public List<CertificationLists> GetCertificates_LocalMachine_My()
        {
            ...
            myCertificateList = GetCertificates(myStore, "My", "LocalMachine");
        ...
        public List<CertificationLists> GetCertificates_LocalMachine_Root()
        {
            ...
            rootCertificateList = GetCertificates(rootStore, "Root", "LocalMachine");
        ...
        public List<CertificationLists> GetCertificates_CurrentUser_My()
        {
            ...
            myCertificateListCurrentUser = GetCertificates(myStoreCurrentUser, "My", "CurrentUser");
        ...
        public List<CertificationLists> GetCertificates_CurrentUser_Root()
        {
            ...
            rootCertificateListCurrentUser = GetCertificates(rootStoreCurrentUser, "Root", "CurrentUser");
